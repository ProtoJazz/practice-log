...
function App() {
  ...
  async function loadRegiments() {
    try {
      ...
      console.log("Loaded regiments:", loadedRegiments);
      let parsedRegiments = JSON.parse(loadedRegiments);
      console.log("Parsed regiments:", parsedRegiments);
